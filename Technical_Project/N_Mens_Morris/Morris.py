...
learned_player = Learned_Player(epsilon=0, alpha=0.000035, gamma=0.9, limit=total_move_no)
multi_task_player = Multi_Task_Player(epsilon=0, alpha=0.000035, gamma=0.9, limit=total_move_no)
